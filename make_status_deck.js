...
s.addText("문서 탐색(RAG) · AI 디자인 패턴 · LangGraph 아키텍처 중심 · 2026-06-17", { x: 2.0, y: 3.9, w: 10.5, h: 0.4, fontFace: F, fontSize: 12.5, color: "AEB9E6", margin: 0 });
...
s.addText("UI 마무리 → 기능 확장 → 운영 고도화", { x: 0.62, y: 1.18, w: 12, h: 0.4, fontFace: F, fontSize: 14, color: ICE, margin: 0 });
[["UI 마무리 (단기)", "P7 좌측 대화이력 세션 저장·복원 · Agent Chat / KPI Dashboard / Approval 탭 구현"],
 ["기능 확장 (중기)", "총 재고 비용 실단가 연동 · 시각 디테일·반응형 개선"],
 ["운영 고도화 (Phase 10)", "Dreaming Memory · Hybrid Search · PostgreSQL 전환 · 실 WMS API 연동 · DES 처리시간 실측 분포"]
].forEach((c, i) => {
  const y = 1.9 + i * 1.7;
